        ...
        <View style={s.container}>
            ...
            <View style={s.ceoSection}>
                ...
                <Text style={s.ceoParagraph}>
                    A IMPERIAL ENGENHARIA possui soluções especializadas para
                    atendimento às normas técnicas e/ou regulamentadoras,
                    através de vistoria, inspeção, regularização e laudos de
                    engenharia. PMOC para sistemas de exaustão para cozinhas e
                    ar condicionado.
                </Text>
                <Text style={s.ceoParagraph}>
                    Além disso, possui capacitação para conduzir auditorias em
                    NR-11 em máquinas industriais e/ou pesadas, assim como
                    sistemas transportadores; e NR-12 para sistemas e
                    equipamentos, a fim de indicar e executar as adequações
                    necessárias.
                </Text>
                <Text style={s.ceoParagraph}>
                    Também oferece projetos de PPCI para obtenção de AVCB/CLCB,
                    além de emitir laudos de segurança do trabalho em
                    conformidade com as NR's. Somos certificados pelo
                    CREA-CONFEA.
                </Text>
                <Text style={s.ceoParagraph}>
                    Entre em contato conosco e conheça um pouco mais como
                    podemos lhe ajudar!
                </Text>
                <View style={s.ceoSignature}>
                    <Text style={s.ceoName}>Andréa Pinheiro</Text>
                    <Text style={s.ceoRole}>
                        Diretora Técnica da Imperial Engenharia
                    </Text>
                </View>
            </View>
        </View>

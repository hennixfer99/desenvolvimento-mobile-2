...
const SOLUTIONS = [
  ...
  },
  {
    icon: 'document-text',
    title: 'Projetos',
    description: 'Personalização de soluções de acordo com as práticas e padrões reconhecidos da engenharia',
  },
  {
    icon: 'build',
    title: 'Planos de Manutenção',
    description: 'Garantir a confiabilidade operacional e segurança para as instalações e pessoas',
  },
  {
    icon: 'people',
    title: 'Treinamentos e Gestão',
    description: 'Padronizar e compartilhar metodologias e estratégias corporativas',
  },
];
...
export default function SolucoesScreen() {
  return (
    <View style={s.container}>
      ...
      <Text style={s.mapSubtitle}>Trabalhamos com clientes em todo território nacional</Text>
      <GreenBanner>
